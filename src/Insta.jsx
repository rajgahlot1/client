      ...
      <div id="slideBar" className="position-fixed">
        <div className="pt-2 ms-1 pb-2 header bg-white d-md-none position-fixed d-flex align-items-center w-100 justify-content-between">
          ...
          <div className="d-flex">
            ...
            <FaRegHeart size={20} className="m-1" />
          </div>
        </div>
        ...
        <div
          style={{ zIndex: "5" }}
          className="bg-white position-fixed position-md-relative d-flex d-md-block flex-row justify-content-around mainIcons"
        >
          ...
          <div className="p-3 pe-md-2 ps-md-0 pt-md-2 pb-md-2 ms-md-2 me-md-2  allIcon">
            <img
